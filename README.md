...
3. Adds quests to each NPC to earn that epic bot gear. Each quest requires the following: 5000 platinum, a familiar ring (Castle Mistmoor), a crafted item that relates to the class, drops from level 38-50 mobs. If you think 5000 platinum isn't a lot, remember a full raid of 71 bots - that's a grand total of 335k platinum. Three full groups, 17 bots - 85k. Five bots for you group - 25k.
